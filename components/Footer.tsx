...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="py-16 px-4 sm:px-8 bg-[#0b0c10] border-t border-gray-800">
      <div className="container mx-auto text-center text-gray-400">
        <h3 className="text-2xl font-bold text-white mb-4">Contacto</h3>
        <p className="mb-4">¿Preguntas o sugerencias? Nos encantaría escucharte.</p>
        <a href="mailto:contacto@fiestatalk.com" className="text-lg text-[#FFD700] hover:underline">
          contacto@fiestatalk.com
        </a>
        ...
        <p className="text-sm">© 2025 FiestaTalk. Todos los derechos reservados.</p>
        <p className="text-sm mt-1">Conectando personas, una conversación a la vez.</p>
      </div>
    </footer>
  );
};
